...
sorteo = draw `The draw for the tournament was held yesterday`

es una gran tarea/empresa = [challenging] undertaking `Starting a new business is a challenging undertaking`
...
poner en riesgo = put at risk `The decision put the project at risk` - `The decision put the company at risk`

Asumir un riesgo
    = take a risk `He took a risk by investing in the stock market` - `She took a risk by starting her own business`

Correr riesgos
    = take risks `He takes risks in his business ventures` - `She takes risks in her personal life`


## Using Aids

hacer uso de algo (usar algo disponible)
    = make use of `We need to make use of the resources we have`

poner en práctica, dar uso
    = put to use <skill|obj>
    ? Estaba ansioso por poner en práctica sus nuevas habilidades de programación : `He was eager to put his new coding skills **to use** on the project`
    ? Los residuos de jardín fueron aprovechados como compost : `The garden waste was put to use as compost`
    ? Deberíamos dar uso a este viejo equipo en lugar de tirarlo : `We should put this old equipment to use instead of throwing it away`
